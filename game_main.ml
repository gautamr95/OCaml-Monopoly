...
move_property game_board 0 None (match get_property_from_name "virginia" with |Some x -> x | None -> failwith "fuck");
move_property game_board 0 None (match get_property_from_name "states" with |Some x -> x | None -> failwith "fuck");
move_property game_board 0 None (match get_property_from_name "stcharles" with |Some x -> x | None -> failwith "fuck");
